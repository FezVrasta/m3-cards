...
| Chip-Markierung | `active_style: chip` mit `label_position: right` | Die aktive Pille umschließt Icon und Text; das Icon sitzt auf einem eigenen, farbig gefüllten Feld. Links und rechts der Pille gleich viel Luft |
