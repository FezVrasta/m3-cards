...
| Knopf an- und abschalten | Im Editor unter Verhalten den Schalter „Runden Knopf neben der Leiste zeigen“ umlegen | Aus: Knopf und Menüfelder verschwinden, `action_button` ist aus der Konfiguration entfernt. An: der Knopf ist sofort da, mit einem Lupensymbol als Startwert |
